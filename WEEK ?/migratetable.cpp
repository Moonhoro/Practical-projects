/*
 *  程序名：migratetable.cpp，本程序是数据中心的公共功能模块，采用刷新的方法同步MySQL数据库之间的表。
 *  作者：moonhoro
 */
#include "_tools.h"
...
void _help(char *argv[])
{
    ...
    printf("Sample:/root/project/tools1/bin/procctl 3600 /root/project/tools1/bin/migratetable /root/log/idc/migratetable_ZHOBTMIND.log \"<connstr>127.0.0.1,root,Ggh.20020902,mysql,3306</connstr><srctname>T_ZHOBTMIND</srctname><dsttname>T_ZHOBTMIND_HIS</dsttname><keycol>keyid</keycol><where>where ddatetime<timestampadd(minute,-120,now())</where><starttime>01,02,03,04,05,13</starttime><maxcount>300</maxcount><timeout>120</timeout><pname>migratetable_ZHOBTMIND</pname>\"\n\n");
