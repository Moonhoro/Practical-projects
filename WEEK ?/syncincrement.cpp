/*
 *  程序名：syncincrement.cpp，本程序是数据中心的公共功能模块，采用刷新的方法同步MySQL数据库之间的表。
 *  作者：moonhoro
 */
#include "_tools.h"
